...
// This app samples a physical ADC signal representing imposed energy.
// It does not measure the powered board's available energy.
...
#ifndef ES_SOURCE
#define ES_SOURCE ES_SOURCE_TRACE
#endif
