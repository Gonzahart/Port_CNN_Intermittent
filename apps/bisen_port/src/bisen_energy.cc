...
const am_hal_adc_slot_config_t kVcapSlot = {
    ...
    .eChannel = AM_HAL_ADC_SLOT_CHSEL_SE4,
...
#else
    // This configures only the BSP's ADCSE4 function after the physical gate
    // in bisen_config.h was explicitly acknowledged.
    if (am_hal_gpio_pinconfig(kVcapAdcGpio, g_AM_BSP_GPIO_ADCSE4) !=
